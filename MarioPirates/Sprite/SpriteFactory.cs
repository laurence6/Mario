    ...
    public sealed class SpriteFactory
    {
        ...
        public Sprite CreateSprite(string spriteName)
        {
            switch (spriteName)
            {
                ...
                case "koopa": return new Sprite("turtles", new Point(30, 24), GenerateFrameLocationArray(new Point(0, 0), new Point(30, 0), 9));
                ...
                case "mario_small_crouch_right": return new Sprite("smallmario", new Point(30, 15), new Point(330, 0));

                case "mario_big_crouch_left": return new Sprite("leftcrouchbigmario", new Point(16, 22), new Point(0, 0));
                ...
                case "mario_big_crouch_right": return new Sprite("rightcrouchbigmario", new Point(16, 22), new Point(0, 0));

                case "mario_fire_crouch_left": return new Sprite("leftcrouchfiremario", new Point(16, 22), new Point(0, 0));
                ...
                case "mario_fire_crouch_right": return new Sprite("rightcrouchfiremario", new Point(16, 22), new Point(0, 0));
